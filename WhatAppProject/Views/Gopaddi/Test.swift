...
//  WhatAppProject
//
//  Created by Daniel Jermaine on 23/08/2025.
//
...
protocol BottomSheetDelegate: AnyObject {
    func bottomSheetDidTapFirstButton(_ sheet: BottomSheetViewController)
    func bottomSheetDidTapSecondButton(_ sheet: BottomSheetViewController)
    func bottomSheetDidDismiss(_ sheet: BottomSheetViewController)
}
...
struct BottomSheetViewController_Previews: PreviewProvider {
    static var previews: some View {
        ...
        ViewControllerPreview {
          UINavigationController(rootViewController:BottomSheetViewController())
        }
